...
public class Netmeds_Page3 extends Netmeds_Testbase{
		...
		WebElement Doctor_Consultation;
		//Start ordering
		@FindBy(xpath="//button[text()='START ORDERING']")
		WebElement Start_Ordering;
		
		//Methods
		public WebElement Start_Ordering() {
			return Start_Ordering;
		}
		public WebElement Doctor_Consultation() {
